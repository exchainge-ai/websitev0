    ...
    <div className="bg-gray-800 py-20 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 font-medium">Simple steps to access world-class AI datasets</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            <div key={index} className="text-center">
              <div className={`w-20 h-20 bg-${step.color}-900/30 rounded-full flex items-center justify-center mx-auto mb-6 border-2 border-${step.color}-500/30`}>
              ...
              <div className="mt-6">
                <span className={`inline-block w-8 h-1 bg-${step.color}-500 rounded-full`}></span>
              </div>
            </div>
          ))}
        </div>
