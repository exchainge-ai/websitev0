...
const UploadCard: React.FC = () => {
  return (
    <div className="bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group border-2 border-dashed border-brand-green-light/40 hover:border-brand-green-light/60 relative ring-2 ring-brand-green-light/20 hover:ring-brand-green-light/40">
      ...
      <div className="h-48 relative overflow-hidden bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 flex items-center justify-center">
        <Upload className="w-16 h-16 text-brand-green-light/60 group-hover:text-brand-green-light transition-all duration-300 group-hover:scale-110" />
