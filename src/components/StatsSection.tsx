...
const StatsSection = () => {
  const stats = [
    { icon: Database, label: 'Datasets', value: '5,000+', color: 'text-blue-400', hoverColor: 'hover-glow-blue' },
    { icon: Users, label: 'AI Researchers', value: '25,000+', color: 'text-purple-400', hoverColor: 'hover-glow-purple' },
    { icon: TrendingUp, label: 'Downloads', value: '500K+', color: 'text-cyan-400', hoverColor: 'hover-glow-cyan' },
    { icon: Globe, label: 'Industries', value: '50+', color: 'text-green-400', hoverColor: 'hover-glow-green' }
  ];
